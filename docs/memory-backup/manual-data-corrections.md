...
**Case 7 — 2026-06-18, Ghana 1–0 Panama** (`game 1fa94b1f…`, fixture `1489385`): Caleb Yirenkyi (`api_player_id 475575`, real id, team=Ghana — NOT a name mismatch) scored Ghana's only goal (in events) but `goals=0` → absent from Top Scorers + reconciliation fail (Σ player goals 0 ≠ score 1). Same lag as Cases 1/3. DEV `probe_stats` → goals:1 confirmed; fixed `UPDATE game_player_stats SET goals=1`. **Found by the end-of-round-1 full verification** (2026-06-18, all 25 finished group games via 2 agents): the ONLY gap — zero name mismatches, zero missing stat blocks, zero negative-id scorers, 24/25 reconciled before this fix; tournament total 77 goals.
