// teams.js — ES module export of all static team + schedule data
// Extracted from js/main.js — do not modify main.js

export const TEAMS = [
  // GROUP A
  { name:'Mexico', code:'mx', group:'A', conf:'CONCACAF', host:true, lat:19.4, lng:-99.1,
    fifaRank:16, best:'Quarter-Finals', times:'2×', lastAchieved:'1986 (Mexico)', lastWC:'2022 (Qatar) — Group Stage',
    schedule:[
  ...
  { name:'Egypt',       code:'eg', group:'G', conf:'CAF',  host:false, lat:30.0, lng:31.2,
    fifaRank:31, best:'Group Stage', times:'3 appearances', lastAchieved:'2018 (Russia)', lastWC:'2018 (Russia) — Group Stage' },
  { name:'Iran',        code:'ir', group:'G', conf:'AFC',  host:false, lat:35.7, lng:51.4,
    fifaRank:20, best:'Group Stage', times:'6 appearances', lastAchieved:'2022 (Qatar)', lastWC:'2022 (Qatar) — Group Stage' },
  { name:'New Zealand', code:'nz', group:'G', conf:'OFC',  host:false, lat:-37.0, lng:175.5,
    fifaRank:86, best:'Group Stage (unbeaten!)', times:'1× — 2010 only', lastAchieved:'2010 (South Africa)', lastWC:'2010 (South Africa) — Group Stage (3 draws, 0 losses)' },
  // GROUP H
  { name:'Spain',        code:'es', group:'H', conf:'UEFA',     host:false, lat:40.4, lng:-3.7,
    fifaRank:1,  best:'World Champion', times:'1×', lastAchieved:'2010 (South Africa)', lastWC:'2022 (Qatar) — Round of 16' },
...
export const HOST_SCHEDULES = {
  'Mexico': {
    ...
    games:[
      ...
      { phase:'group', round:'Group A · MD1', date:'Thu, Jun 11', idt:'05:00', idtDate:'Jun 12 ⁺¹', home:'South Korea',  hCode:'kr', away:'UEFA PO-D',    aCode:null, venue:'Estadio Akron',  city:'Guadalajara',  capacity:'49,850' },
      { phase:'group', round:'Group F · MD1', date:'Sun, Jun 14', idt:'05:00', idtDate:'Jun 15 ⁺¹', home:'UEFA PO-B',    hCode:null, away:'Tunisia',      aCode:'tn', venue:'Estadio BBVA',   city:'Monterrey',    capacity:'53,500' },
      ...
      { phase:'group', round:'Group K · MD2', date:'Tue, Jun 23', idt:'05:00', idtDate:'Jun 24 ⁺¹', home:'Colombia',     hCode:'co', away:'IC PO-1',      aCode:null, venue:'Estadio Akron',  city:'Guadalajara',  capacity:'49,850' },
  ...
  'Canada': {
    ...
    games:[
      ...
      { phase:'group', round:'Group D · MD1', date:'Fri, Jun 12', idt:'07:00', idtDate:'Jun 13 ⁺¹', home:'Australia',   hCode:'au',     away:'UEFA PO-C',   aCode:null,     venue:'BC Place',  city:'Vancouver',  capacity:'54,500' },
      ...
      { phase:'group', round:'Group I · MD3', date:'Fri, Jun 26', idt:'22:00', idtDate:'Jun 26',     home:'Senegal',     hCode:'sn',     away:'IC PO-2',     aCode:null,     venue:'BMO Field', city:'Toronto',    capacity:'45,000' },
