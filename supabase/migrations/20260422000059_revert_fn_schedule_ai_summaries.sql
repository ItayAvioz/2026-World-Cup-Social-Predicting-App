-- M59: revert fn_schedule_ai_summaries to original (AI summary crons only)
-- M58 mistakenly added auto-predict logic here; auto-predict is handled by fn_schedule_auto_predictions()
