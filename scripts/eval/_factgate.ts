// @ts-nocheck
// factgate.ts — deterministic fact-gate + escalation for nightly-summary EF.
// Evaluator core is SLICED VERBATIM from scripts/eval/evaluate.cjs so the EF gate == the offline gate.
// Regenerate via scripts/eval/gen-factgate.cjs; do not hand-edit the evaluator section.
